...
export const OPTIONAL_HOUR_IDS = ["dead"] as const;
export const REQUIRED_HOURS = HOURS.filter(
  (hour) => !OPTIONAL_HOUR_IDS.includes(hour.id as (typeof OPTIONAL_HOUR_IDS)[number])
);
export const TOTAL_DAILY_PATERS = REQUIRED_HOURS.reduce((sum, h) => sum + h.paterCount, 0); // 76
...
export const PRAYERS: PrayerText[] = [
  ...
  },
  {
    ...
    latin: "Altissime, omnipotens, bone Domine,\ntuae sunt laudes, gloria et honor et omnis benedictio.\nTibi soli, Altissime, conveniunt,\net nullus homo dignus est nomen tuum proferre.\n\nLaudatus sis, Domine mi, cum universis creaturis tuis,\nspecialiter domino fratre Sole,\nqui diem facit et per quem nos illuminas.\nEt ipse pulcher est et radicans magno splendore:\nde te, Altissime, significationem gerit.\n\nLaudatus sis, Domine mi, pro sorore Luna et stellis:\nin caelo eas formasti claras, pretiosas et pulchras.\n\nLaudatus sis, Domine mi, pro fratre Vento\net pro aere et nubilo et sereno et omni tempore,\nper quae creaturis tuis sustentationem tribuis.\n\nLaudatus sis, Domine mi, pro sorore Aqua,\nquae est valde utilis et humilis et pretiosa et casta.\n\nLaudatus sis, Domine mi, pro fratre Igne,\nper quem noctem illuminas.\nEt ipse pulcher est et iucundus et robustus et fortis.\n\nLaudatus sis, Domine mi, pro sorore nostra matre Terra,\nquae nos sustinet et gubernat,\net producit diversos fructus cum floribus coloratis et herbis.\n\nLaudate et benedicite Domino meo,\net gratias agite et servite ei cum magna humilitate.",
